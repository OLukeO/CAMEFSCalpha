...
class JudgeDController extends StoreController
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $test = $this->onehourmain($UID, (int) $beaconid, (float) $distance);
        //將收到資料回傳
    ...
    public function judge($distance, $beacon, $UID)
    {
        ...
        //前一筆資料的距離
        $Distance = (float) implode(' ', array_column($befdistance, 'distance'));
        //如果沒有前一筆資料
        if ($befdistance == null) {
            $Distance = 100;
        }
    ...
    public function humandata($BID, $BID1)
    {
        ...
        return [$befpeople, $nowpeople, $befAID, $nowAID];
    }
    ...
    public function onehourpeople($UID, $BID, $attractionid)
    {
        ...
        //回傳需要資料
        return [$time2, $time3, $hwmanypeople, $nowtime0, $timePlus];
    }
